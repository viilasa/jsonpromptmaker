              ...
              <CardContent className="flex-1 overflow-hidden flex flex-col p-0">
                <div className="p-3 sm:p-4 border-b">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="font-medium text-sm sm:text-base">Video Prompt Status</h3>
                    </div>
                  </div>
                </div>
                <div className="flex-1 overflow-auto p-3 sm:p-4 bg-background">
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-muted/50 p-3 sm:p-4 rounded-md">
                      <h4 className="font-medium mb-2 text-sm sm:text-base">Video Concept</h4>
                    ...
                    <div className="bg-muted/50 p-3 sm:p-4 rounded-md">
                      <h4 className="font-medium mb-2 text-sm sm:text-base">Enhanced Video Prompt Preview</h4>
                      <div className="space-y-3">
                        <div>
                          <h5 className="font-medium text-xs sm:text-sm">Enhanced Concept</h5>
                    ...
                    <div className="bg-muted/50 p-3 sm:p-4 rounded-md">
                      <h5 className="font-medium mb-2 text-sm sm:text-base">Production Specifications</h5>
